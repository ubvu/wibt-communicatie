...
Use the **EU AI-content icons** — optional but recommended (free, pre-tested for perceivability):
...
| Mistake | Reality |
|---|---|
| "I edited the AI text a bit, so no disclosure needed" | Only genuine editorial review + assumed, named editorial responsibility exempts text — and only text. Light copyediting isn't enough. |
...
| "The caption got cropped when it was reused on social" | Labels must persist through reshares/downloads — a Code of Practice placement requirement, not a nice-to-have. |
